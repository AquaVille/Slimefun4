...
public final class SlimefunItems {
    ...
    public static final SlimefunItemStack SOULBOUND_RUNE = new SlimefunItemStack("ANCIENT_RUNE_SOULBOUND", ColoredFireworkStar.create(Color.fromRGB(47, 0, 117), "&7Ancient Rune &8&l[&5&lSoulbound&8&l]", "", "§fDrop this rune onto a dropped item to", "§5bind §fthat item to your soul.", " ", "§fIt is advised that you only use this rune", "§fon §6important §fitems.", " ", "§aItems bound to your soul won't drop on death."));
    public static final SlimefunItemStack ENCHANTMENT_RUNE = new SlimefunItemStack("ANCIENT_RUNE_ENCHANTMENT", ColoredFireworkStar.create(Color.fromRGB(255, 217, 25), "&7Ancient Rune &8&l[&6&lEnchantment&8&l]", "", "§fDrop this rune onto a dropped item", "§fto §6enchant §fthat item with a random","§fenchantment."));
    public static final SlimefunItemStack VILLAGER_RUNE = new SlimefunItemStack("ANCIENT_RUNE_VILLAGERS", ColoredFireworkStar.create(Color.fromRGB(160, 20, 5), "&7Ancient Rune &8&l[&4&lVillagers&8&l]", "", "§fRight click a villager to clear", "§ftheir current job and trades.", "§fThe villager will start looking", "§ffor a job again after some", "§ftime has passed."));
